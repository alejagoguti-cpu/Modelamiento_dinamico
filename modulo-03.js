...
/* -------- Tipos de relación — Módulo 03: Discurso vs Realidad -------- */
const TYPE_STYLE = {
  dependencia:       { color: "#ef4444", width: 2.6, label: "Dependencia" },
  condicionamiento:  { color: "#f472b6", width: 2.6, label: "Condicionamiento" },
  causal:            { color: "#60a5fa", width: 2.6, label: "Relación Causal" },
  funcional:         { color: "#c084fc", width: 2.6, label: "Relación Funcional" },
...
const RAW_EDGES = [
  /* Dependencias: X necesita Y para existir */
  { s: "vivienda",   t: "servpub",        type: "dependencia",       directa: true,  cat: "e2", pagina: "43", sustento: "La vivienda depende fundamentalmente de servicios públicos para ser habitable." },
  { s: "transporte", t: "redvial",        type: "dependencia",       directa: true,  cat: "e2", pagina: "43", sustento: "El transporte público depende de la red vial como infraestructura." },
  { s: "coberturas", t: "resiliencia",    type: "dependencia",       directa: true,  cat: "e1", pagina: "186", sustento: "Las áreas de resiliencia climática dependen de coberturas vegetales para funcionar." },
  
  /* Condicionamientos: X se condiciona por Y */
  { s: "densificacion", t: "vivienda",    type: "condicionamiento",  directa: true,  cat: "e2", pagina: "43", sustento: "La densificación de vivienda se condiciona por disponibilidad de equipamientos." },
  { s: "expansion",      t: "servicios",  type: "condicionamiento",  directa: false, cat: "e2", pagina: "43", sustento: "La expansión urbana se condiciona por la expansión de servicios públicos." },
  
  /* Causales: X causa Y */
  { s: "autopistas",    t: "fragmentacion", type: "causal",           directa: true,  cat: "e1-e2", pagina: "92", sustento: "Las autopistas causan fragmentación del territorio ecológico." },
  { s: "concentracion", t: "desigualdad",   type: "causal",           directa: true,  cat: "e3", pagina: "239-241", sustento: "La concentración de inversión causa desigualdad territorial." },
  
  /* Funcionales: X funciona con Y */
  { s: "manzanas",      t: "parques",       type: "funcional",        directa: true,  cat: "e2", pagina: "43", sustento: "Las Manzanas del Cuidado funcionan con parques como infraestructura." },
  { s: "equip",         t: "transporte",    type: "funcional",        directa: true,  cat: "e2", pagina: "43", sustento: "Los equipamientos funcionan con transporte para ser accesibles." },
  
  /* Complementariedades: X se complementa con Y */
  { s: "ciclorutas",    t: "transporte",    type: "complementariedad", directa: true,  cat: "e2", pagina: "43", sustento: "Las ciclorrutas se complementan con el transporte público." },
  { s: "corredores",    t: "humedales",     type: "complementariedad", directa: true,  cat: "e1-e2", pagina: "92", sustento: "Los corredores verdes se complementan con sistemas hídricos." },
  
  /* Conflictos: X entra en conflicto con Y */
  { s: "densificacion", t: "coberturas",    type: "conflicto",        directa: true,  cat: "e1-e2", pagina: "186", sustento: "La densificación de vivienda entra en conflicto con protección de coberturas vegetales." },
  { s: "autopistas",    t: "eep",           type: "conflicto",        directa: true,  cat: "e1-e2", pagina: "92", sustento: "Las autopistas entran en conflicto directo con la Estructura Ecológica Principal." },
  { s: "turismo",       t: "produccion",    type: "conflicto",        directa: false, cat: "e3-e4", pagina: "239-241", sustento: "El turismo de consumo entra en conflicto con producción artesanal local." },
  
  /* Jerarquías: X está jerárquicamente arriba de Y */
  { s: "economia",      t: "ecologia",      type: "jerarquia",        directa: true,  cat: "e1-e3", pagina: "92", sustento: "La lógica económica está jerárquicamente arriba de la lógica ecológica." },
  { s: "movilidad",     t: "cuidado",       type: "jerarquia",        directa: true,  cat: "e2", pagina: "43", sustento: "La movilidad está jerárquicamente arriba del cuidado en las prioridades." },
  
  /* Retroalimentaciones: X afecta Y que afecta X */
  { s: "densificacion", t: "servicios",     type: "retroalimentacion", directa: true,  cat: "e2", pagina: "43", sustento: "Densificación aumenta demanda de servicios que atraen más densificación." },
  { s: "expansion",     t: "infraestructura", type: "retroalimentacion", directa: true, cat: "e2", pagina: "43", sustento: "Expansión requiere infraestructura que habilita más expansión." },
];
...
function filterNetwork(mode) {
  ...
  const groups = {
    all:                  { types: ["dependencia", "condicionamiento", "causal", "funcional", "complementariedad", "conflicto", "jerarquia", "retroalimentacion"], cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    dependencia:          { types: ["dependencia"],          cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    condicionamiento:     { types: ["condicionamiento"],     cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    causal:               { types: ["causal"],               cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    funcional:            { types: ["funcional"],            cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    complementariedad:    { types: ["complementariedad"],    cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    conflicto:            { types: ["conflicto"],            cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    jerarquia:            { types: ["jerarquia"],            cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
    retroalimentacion:    { types: ["retroalimentacion"],    cats: ["e1", "e2", "e3", "e4", "e1-e2", "e2-e3", "e3-e4", "e1-e4"] },
  };
