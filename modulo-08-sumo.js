...
(() => {
  ...
  start(() => {
    ...
    function drawNetwork(w, h) {
      ...
      netCtx.fillStyle = "rgba(185,206,225,0.12)";
      netCtx.strokeStyle = "rgba(151,172,201,0.22)";
      ...
      netCtx.strokeStyle = "rgba(151,172,201,0.3)";
      ...
      if (treeData) {
        ...
        netCtx.fillStyle = "rgba(139,168,136,0.4)";
