...
const scaleNetworks = {
  ...
  cultural: {
    ...
    accent: '#e89a6c',
    nodes: [
      { id: 'patrimonio_material', label: 'PATRIMONIO MATERIAL', lat: 4.615, lng: -74.075, hub: true, icon: 'fa-landmark' },
      { id: 'patrimonio_inmaterial', label: 'PATRIMONIO INMATERIAL', lat: 4.635, lng: -74.045, hub: true, icon: 'fa-masks-theater' },
      { id: 'museos', label: 'MUSEOS', lat: 4.640, lng: -74.085, icon: 'fa-image' },
      { id: 'bibliotecas', label: 'BIBLIOTECAS', lat: 4.595, lng: -74.105, icon: 'fa-book' },
      { id: 'plazas_mercado', label: 'PLAZAS DE MERCADO', lat: 4.605, lng: -74.120, icon: 'fa-store' },
      { id: 'barrios', label: 'BARRIOS', lat: 4.650, lng: -74.115, icon: 'fa-house' },
      { id: 'centros_historicos', label: 'CENTROS HISTÓRICOS', lat: 4.625, lng: -74.100, icon: 'fa-building' },
      { id: 'zonas_turisticas', label: 'ZONAS DE INTERÉS TURÍSTICO', lat: 4.675, lng: -74.070, icon: 'fa-camera' },
      { id: 'equipamientos_culturales', label: 'EQUIPAMIENTOS CULTURALES', lat: 4.570, lng: -74.080, icon: 'fa-palette' },
      { id: 'artesanias', label: 'PRODUCCIÓN ARTESANAL', lat: 4.585, lng: -74.055, icon: 'fa-hammer' },
      { id: 'rutas_patrimoniales', label: 'RUTAS PATRIMONIALES', lat: 4.555, lng: -74.105, icon: 'fa-route' },
      { id: 'mercados_barriales', label: 'MERCADOS BARRIALES', lat: 4.565, lng: -74.135, icon: 'fa-cart-shopping' },
      { id: 'centros_comunitarios', label: 'CENTROS COMUNITARIOS', lat: 4.545, lng: -74.075, icon: 'fa-people-group' },
      { id: 'escuelas_musica', label: 'ESCUELAS DE MÚSICA', lat: 4.555, lng: -74.045, icon: 'fa-music' }
    ],
    edges: [
  ...
  tecnologico: {
    ...
    accent: '#e89a6c',
    nodes: [
      { id: 'red_vial', label: 'RED VIAL', lat: 4.635, lng: -74.100, hub: true, icon: 'fa-road' },
      { id: 'transporte_publico', label: 'TRANSPORTE PÚBLICO', lat: 4.605, lng: -74.070, hub: true, icon: 'fa-bus' },
      { id: 'red_ferrrea', label: 'RED FÉRREA', lat: 4.665, lng: -74.095, icon: 'fa-train-subway' },
      { id: 'ciclorutas', label: 'CICLORRUTAS', lat: 4.655, lng: -74.135, icon: 'fa-person-biking' },
      { id: 'nodos_digitales', label: 'NODOS DIGITALES', lat: 4.680, lng: -74.145, icon: 'fa-network-wired' },
      { id: 'internet_publico', label: 'INTERNET PÚBLICO', lat: 4.585, lng: -74.135, icon: 'fa-wifi' },
      { id: 'datos_abiertos', label: 'DATOS ABIERTOS', lat: 4.575, lng: -74.080, icon: 'fa-database' },
      { id: 'centro_tecnologico', label: 'CENTRO TECNOLÓGICO', lat: 4.625, lng: -74.045, icon: 'fa-microchip' },
      { id: 'recarga_electrica', label: 'RECARGA ELÉCTRICA', lat: 4.685, lng: -74.055, icon: 'fa-bolt' },
      { id: 'semaforizacion', label: 'SEMAFORIZACIÓN', lat: 4.550, lng: -74.105, icon: 'fa-traffic-light' },
      { id: 'electrolineras', label: 'ELECTROLINERAS', lat: 4.555, lng: -74.160, icon: 'fa-charging-station' },
      { id: 'fibra_optica', label: 'FIBRA ÓPTICA', lat: 4.565, lng: -74.120, icon: 'fa-cable' },
      { id: 'centros_datos', label: 'CENTROS DE DATOS', lat: 4.545, lng: -74.065, icon: 'fa-server' },
      { id: 'subestaciones', label: 'SUBESTACIONES', lat: 4.555, lng: -74.045, icon: 'fa-tower-transmission' }
    ],
    edges: [
  ...
  metaverso: {
    ...
    accent: '#46d6d0',
    nodes: [
      { id: 'gemelo_digital', label: 'GEMELO DIGITAL', lat: 4.630, lng: -74.100, hub: true, icon: 'fa-cube' },
      { id: 'modelos_3d', label: 'MODELOS 3D', lat: 4.665, lng: -74.130, hub: true, icon: 'fa-cubes' },
      { id: 'capas_gis', label: 'CAPAS GIS', lat: 4.680, lng: -74.085, icon: 'fa-layer-group' },
      { id: 'plataformas_bim', label: 'PLATAFORMAS BIM', lat: 4.650, lng: -74.055, icon: 'fa-building' },
      { id: 'nodos_iot', label: 'NODOS IoT', lat: 4.605, lng: -74.045, icon: 'fa-microchip' },
      { id: 'visualizacion_vr', label: 'VISUALIZACIÓN VR', lat: 4.575, lng: -74.065, icon: 'fa-vr-cardboard' },
      { id: 'laboratorios_urbanos', label: 'LABORATORIOS URBANOS', lat: 4.565, lng: -74.115, icon: 'fa-flask' },
      { id: 'datos_territoriales', label: 'DATOS TERRITORIALES', lat: 4.600, lng: -74.150, icon: 'fa-database' },
      { id: 'escenarios_simulados', label: 'ESCENARIOS SIMULADOS', lat: 4.700, lng: -74.115, icon: 'fa-simulation' },
      { id: 'sensores_urbanos', label: 'SENSORES URBANOS', lat: 4.640, lng: -74.180, icon: 'fa-satellite' },
      { id: 'escaneo_urbano', label: 'ESCANEO URBANO', lat: 4.555, lng: -74.165, icon: 'fa-camera' },
      { id: 'nube_puntos', label: 'NUBE DE PUNTOS', lat: 4.565, lng: -74.120, icon: 'fa-cloud' },
      { id: 'simulador_movilidad', label: 'SIMULADOR DE MOVILIDAD', lat: 4.545, lng: -74.075, icon: 'fa-car' },
      { id: 'laboratorio_inmersivo', label: 'LABORATORIO INMERSIVO', lat: 4.555, lng: -74.045, icon: 'fa-headset' }
    ],
    edges: [
...
function buildPopupAmbientMesh() {
  const w = 1000, h = 544;
  ...
  for (let i = 0; i < cols; i++) {
    for (let j = 0; j < rows; j++) {
      ...
      const baseY = (j + 0.5) / rows * h;
      const jitterX = (((i * 37 + j * 19) % 23) - 11) * 4;
      const jitterY = (((i * 17 + j * 41) % 29) - 14) * 4;
  ...
  for (let i = 0; i < seedPts.length; i++) {
    for (let j = i + 1; j < seedPts.length; j++) {
      ...
      if (d < THRESH && (a.idx + b.idx) % 3 !== 0) {
        linesMarkup += `<line x1="${a.x.toFixed(1)}" y1="${a.y.toFixed(1)}" x2="${b.x.toFixed(1)}" y2="${b.y.toFixed(1)}" stroke="${palette[a.idx % 4]}" stroke-width="0.6" opacity="0.22" />`;
      }
    }
  }
  ...
  let dotsMarkup = '';
  seedPts.forEach(p => {
    const r = (p.idx % 5 === 0) ? 3.2 : 1.8;
    const op = (p.idx % 5 === 0) ? '0.55' : '0.4';
    dotsMarkup += `<circle cx="${p.x.toFixed(1)}" cy="${p.y.toFixed(1)}" r="${r}" fill="${palette[p.idx % 4]}" opacity="${op}" />`;
  });

  return `<g class="popup-ambient-mesh" opacity="0.5">${linesMarkup}${dotsMarkup}</g>`;
}
...
function renderScaleNetworkPopup(mode) {
  ...
  const ambientMesh = buildPopupAmbientMesh();
