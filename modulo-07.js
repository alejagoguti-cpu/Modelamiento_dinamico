(() => {
  ...
  start(() => {
    ...
    function initRealCartography() {
      ...
      map.on("load", () => { const burro = { type: "FeatureCollection", features: [{ type: "Feature", properties: { name: "Humedal El Burro" }, geometry: { type: "Polygon", coordinates: [[[-74.166,4.644],[-74.159,4.647],[-74.153,4.644],[-74.151,4.638],[-74.156,4.633],[-74.163,4.634],[-74.168,4.639],[-74.166,4.644]]] } }] }; const context = { type: "FeatureCollection", features: [ { type: "Feature", properties: { name: "Avenida Ciudad de Cali", kind: "avenue" }, geometry: { type: "LineString", coordinates: [[-74.159,4.67],[-74.159,4.65],[-74.159,4.63],[-74.159,4.61]] } }, { type: "Feature", properties: { name: "Canal Los Ángeles", kind: "canal" }, geometry: { type: "LineString", coordinates: [[-74.181,4.649],[-74.174,4.645],[-74.167,4.641],[-74.158,4.637]] } }, { type: "Feature", properties: { name: "Ciclorruta", kind: "cycle" }, geometry: { type: "LineString", coordinates: [[-74.15,4.632],[-74.156,4.631],[-74.164,4.632],[-74.172,4.636]] } }, { type: "Feature", properties: { name: "Biblioteca El Tintal", kind: "library" }, geometry: { type: "Point", coordinates: [-74.156,4.633] } }, { type: "Feature", properties: { name: "Río Tunjuelo · cuenca", kind: "river" }, geometry: { type: "LineString", coordinates: [[-74.205,4.59],[-74.19,4.60],[-74.175,4.61],[-74.16,4.62]] } } ] }; map.addSource("burro", { type: "geojson", data: burro }); map.addLayer({ id: "burro-fill", type: "fill", source: "burro", paint: { "fill-color": "#20e0c0", "fill-opacity": .7 } }); map.addLayer({ id: "burro-line", type: "line", source: "burro", paint: { "line-color": "#ffffff", "line-width": 5, "line-opacity": 1 } }); map.addSource("burro-context", { type: "geojson", data: context }); map.addLayer({ id: "burro-context-lines", type: "line", source: "burro-context", filter: ["!=", ["geometry-type"], "Point"], paint: { "line-color": "#ffffff", "line-width": ["match", ["get", "kind"], "avenue", 3, "canal", 2, "cycle", 2, 2], "line-opacity": .9 } }); map.addLayer({ id: "burro-label", type: "symbol", source: "burro", layout: { "text-field": "{name}", "text-size": 13, "text-font": ["Open Sans Bold"] }, paint: { "text-color": "#8ffff0", "text-halo-color": "#08100f", "text-halo-width": 2 } }); map.addLayer({ id: "burro-context-labels", type: "symbol", source: "burro-context", layout: { "text-field": "{name}", "text-size": 10, "text-offset": [0, 1.1], "text-anchor": "top" }, paint: { "text-color": "#ffffff", "text-halo-color": "#000000", "text-halo-width": 2 } }); const burroMarker = document.createElement("div"); burroMarker.className = "burro-focus-label"; burroMarker.innerHTML = "<b>HUMEDAL EL BURRO</b><span>Reserva · agua · borde urbano</span>"; new maplibregl.Marker({ element: burroMarker, anchor: "bottom" }).setLngLat([-74.159, 4.64]).addTo(map); setStatus("BOGOTÁ · LECTURA GENERAL", true); window.setTimeout(() => runCartographyOpening(map), 850); });
