...
const renderTerritoryNetwork = () => {
    ...
    const UNIFIED_URBAN_ELEMENTS = [
      ...
      { id: "c_jardines", name: "Jardines\ninfantiles", icon: "fa-child-reaching", systemId: "cuidado", color: "#c6a0e9", x: 6, y: 62, soloRedCompleta: true, desc: "Primera infancia y cuidado diario en los barrios del entorno del humedal.", connects: ["s_cuidado", "se_vivienda", "c_salud_barrial"] },
      { id: "c_salud_barrial", name: "Puestos de salud\nbarrial", icon: "fa-house-medical", systemId: "cuidado", color: "#c6a0e9", x: 4, y: 48, soloRedCompleta: true, desc: "Atención primaria de proximidad para las comunidades vecinas.", connects: ["s_vecinos", "se_equipamientos", "c_jardines", "c_espacio_publico"] },
      { id: "c_espacio_publico", name: "Espacio público\ny plazoletas", icon: "fa-tree-city", systemId: "cuidado", color: "#c6a0e9", x: 14, y: 92, soloRedCompleta: true, desc: "Andenes, plazoletas y zonas de encuentro que sostienen la vida cotidiana.", connects: ["m_peatonal", "f_andenes", "c_salud_barrial"] },

      { id: "p_memoria_local", name: "Memoria\ndel barrio", icon: "fa-clock-rotate-left", systemId: "patrimonio", color: "#f07bb1", x: 4, y: 10, soloRedCompleta: true, desc: "Relatos y archivos comunitarios sobre la transformación del territorio.", connects: ["s_org_amb", "s_pedagogia", "p_tradiciones"] },
      { id: "p_patrimonio_construido", name: "Patrimonio\nconstruido", icon: "fa-landmark", systemId: "patrimonio", color: "#f07bb1", x: 96, y: 10, soloRedCompleta: true, desc: "Edificaciones y trazados con valor histórico o simbólico para la comunidad.", connects: ["f_edificios", "f_cerramientos", "p_memoria_local"] },
      { id: "p_tradiciones", name: "Tradiciones y\nsaberes locales", icon: "fa-masks-theater", systemId: "patrimonio", color: "#f07bb1", x: 50, y: 98, soloRedCompleta: true, desc: "Prácticas culturales y saberes ambientales transmitidos entre generaciones.", connects: ["s_pedagogia", "b_flora", "p_patrimonio_construido"] },

      { id: "i_alcaldia_local", name: "Alcaldía\nlocal", icon: "fa-building-columns", systemId: "institucional", color: "#9d8be8", x: 96, y: 62, soloRedCompleta: true, desc: "Gestión administrativa y presupuestal del territorio a escala local.", connects: ["s_conflictos", "se_suelo", "i_curaduria"] },
      { id: "i_curaduria", name: "Curaduría y\nnormativa", icon: "fa-stamp", systemId: "institucional", color: "#9d8be8", x: 98, y: 48, soloRedCompleta: true, desc: "Licencias y normas urbanísticas que regulan lo que se construye.", connects: ["f_edificios", "se_suelo", "i_alcaldia_local", "i_control_ambiental"] },
      { id: "i_control_ambiental", name: "Control y vigilancia\nambiental", icon: "fa-clipboard-check", systemId: "institucional", color: "#9d8be8", x: 88, y: 92, soloRedCompleta: true, desc: "Inspección y seguimiento del cumplimiento de las normas ambientales.", connects: ["h_desborde", "b_refugio", "i_curaduria"] }
    ];
