(() => {
  ...
  start(() => {
    ...
    const subsystemData = [
      { name: "Dinámica hídrica", short: "AGUA", color: "#4bd7ef", x: 17, y: 26, process: "Entrada, circulación, acumulación y salida del agua; vínculo con el Canal Los Ángeles y residuos.", actants: ["Canal Los Ángeles", "escorrentía", "residuos", "ronda hídrica"] },
      { name: "Transformación ecológica", short: "ECOLOGÍA", color: "#67e8a5", x: 40, y: 18, process: "Cambios del espejo de agua, vegetación nativa e invasora, insectos, aves residentes y migratorias.", actants: ["aves migratorias", "vegetación nativa", "pasto kikuyo", "polinizadores"] },
      { name: "Fragmentación urbana", short: "BORDE", color: "#f5a623", x: 73, y: 23, process: "Reducción histórica del área y división por la Avenida Ciudad de Cali, edificios y bordes modificados.", actants: ["Avenida Ciudad de Cali", "edificios", "escombros", "borde urbano"] },
      { name: "Movilidad y accesibilidad", short: "MOVILIDAD", color: "#f76fb0", x: 82, y: 49, process: "Tráfico, ruido, contaminación, recorridos por la ciclorruta y acceso a la Biblioteca El Tintal.", actants: ["ciclorruta", "Biblioteca El Tintal", "peatones", "tráfico y ruido"] },
      { name: "Usos comunitarios", short: "COMUNIDAD", color: "#b08cff", x: 66, y: 75, process: "Visitas, educación ambiental, participación, apropiación, recorridos y acciones organizativas.", actants: ["Juntas de Acción Comunal", "grupos locales", "visitas", "educación ambiental"] },
      { name: "Restauración adaptativa", short: "RESTAURAR", color: "#e89a6c", x: 35, y: 78, process: "Reintroducción de vegetación, control de invasoras, mantenimiento, compostaje y coordinación institucional.", actants: ["Jardín Botánico", "Hospital del Sur", "Ciudad Limpia", "UAESP"] },
      { name: "Riesgo y servicios", short: "RESILIENCIA", color: "#ff6b78", x: 12, y: 60, process: "El humedal retiene agua y nutrientes, mejora su calidad y ayuda a mitigar inundaciones y cambio climático.", actants: ["inundaciones", "calidad del agua", "ZMPA", "cuenca del Tunjuelo"] },
    ];
